package MethodParameterRangeLimitationPattern.OnRangeList;
...
public class RangeLimitationwithRangeistStaticInstrumenter extends BodyTransformer {
	...
	public RangeLimitationwithRangeistStaticInstrumenter(String satatPath) {
	...
	protected void internalTransform(Body body, String phase, Map options) {
		...
		if (!methodIsPrivate && !MethodCreatedBycompiler) {
			...
			RangeLimitationWithRangeListAnalysis typeRestrictionAnalysis = new RangeLimitationWithRangeListAnalysis(
					cfg);
	...
	private Map<Local, ArrayList<PatternOccurrenceInfo>> detectRestrictedTypePatern(
			...
			RangeLimitationWithRangeListAnalysis typeRestrictionAnalysis) {
